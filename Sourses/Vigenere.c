...
int main(int argc, string argv[])
{
    ...
    {
        //printf("t=%d, n1=%d, KeyLenth=%d, KeyWord=%s\t", t, n1, KeyLenth, KeyWord);
        ...
        //printf("\t t=%d, n1=%d, KeyLenth=%d, KeyWord=%s\n", t, n1, KeyLenth, KeyWord);
    }
    return 0;
}
...
void PrintEncUppLetter(char Letter)
{
    KeyLenth = ((int) KeyWord[t]) - 65; //Calculate KeyLenth
    (t < (n1 - 1)) ? t++ : (t = 0);
...
void PrintEncDigit(char Letter)
{
    KeyLenth = ((int) KeyWord[t]) - 48; //Calculate KeyLenth
    (t < (n1 - 1)) ? t++ : (t = 0);
